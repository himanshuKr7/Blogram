    ...
    return (
        <Typography>
            <Navbar
                ...
                style={{ backgroundColor: mode === 'light' ? "#ffff" : 'rgb(30, 41, 59)'  }}>
                ...
                <div className="flex items-center justify-between text-gray-200">
                    ...
                    <Link to={'/'}>
                        ...
                        >
                            <img
                                ...
                                src="logo.svg"
                            />
                            <span className="text-blue-700  text-3xl sm:block hidden">
                               Blogram
                            </span>
                        </Typography>
                    </Link>
                    <div className="flex items-center gap-4">
                            ...
                            {admin?<Link to={'/dashboard'}>
                                <div className="">
                                    <Avatar
                                        ...
                                        alt="avatar"
                                        withBorder={true}
                                        className="p-0.5 text-blue-500 w-10 h-10"
                                        style={{
                                            border:
                                                mode === 'dark'
                                                    ?
                        ...
                        <div>
                            <IconButton onClick={toggleMode} className="lg:inline-block rounded-full" style={{ background: mode === 'light' ? '#f5f5f5' : '#57606f', color: mode === 'dark' ? 'white' : 'black' }}>
                                {mode === 'light' ? (
